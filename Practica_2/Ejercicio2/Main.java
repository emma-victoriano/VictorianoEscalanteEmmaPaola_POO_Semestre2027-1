...
public class mainComputadora{
    ...
    public static void main(String[]args){
        ...
        // Se crea el arreglo de solo 2 computadoras 
        ...
        do{
            ...
            // Instanciamos el objeto vacio usando el constructor por defecto
            ...
            computadoras[i].setMemoriaRam(memoriaRam); // Asignacion con setter
            ...
            computadoras[i].setAlmacenamiento(almacenamiento); // Asignacion con setter
            ...
            computadoras[i].setFuenteEnergia(fuenteEnergia); // Asignacion con setter
            ...
            computadoras[i].setCpu(cpu); // Asignacion con setter
            ...
            computadoras[i].setGpu(gpu); // Asignacion con setter
